...
### Diagnostics
- `md --verbose <command> ...` / `md -V <command> ...` - Show task, webhook, and Git actions with elapsed timings on stderr (global flag; place it before the command). Lowercase `-v` remains the version flag
